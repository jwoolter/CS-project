...
weapons = {"sword": (1, 3, 1), "fists": (0, 2, 1), "axe": (0, 6, 1), "spear": (3,4,1), "hammer": (2, 8, 1), "tentacle":(0, 1, 10)}

# boss dictionary Key = name values = description, health

bosses = {"King of bananas": ("leader of the monkeys", 5, ["finds an opening and jumps on you", "you get squashed in the process"]), "Litius": ("pincher of men", 6, ["litius opens his pincer and grabs you","you have been crushed"]), "Mr. Squid": ("creater of storms", 8, ["waves his tentacle and slaps you", "you fly into the sea unconscious"])}
